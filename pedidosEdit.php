...
//	mysql_select_db($database, $conexao);
	...
	$queryPed = mysql_query($query, $conexao) or die(mysql_error());
	$pedidos = mysql_fetch_assoc($queryPed);
	$totalPed = mysql_num_rows($queryPed);
...
<form class="form-horizontal" action="files/php/cadPedidos.php" method="post">
    <legend>Edição de Pedidos</legend>
    
    <?php if (isset($_GET['res'])) { ?>
    <?php if ($_GET['res'] == 'success') { ?>
    	<div class="alert alert-success">
        	<b>Pedido atualizado com sucesso!</b>
		</div>
	...
	<div class="control-group">
        ...
        <div class="controls">
            <input type="text" name="cliente" class="span4" value="<?php echo $pedidos['cliente']; ?>" readonly="readonly" />
        </div>
    </div>
...
<script type="text/javascript">        
	$(document).ready(function(){
		$('.calc').keyup(function(){
			...
			var totalfrutas = total1 + total2 + total3 + total4 + total5 + total6 + total7 + total8 + total9 + total10 + total11 + total12 + total13 + total14 + total15 + total16 + total17 + total18 + total19 + total20 + total21 + total22 + total23 + total24;
